...
app.post('/commission', async (req, res) => {
  ...
  try {
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:'Poppins',sans-serif;background:#0f0f17;color:#dde8f0;padding:32px;border-radius:8px;max-width:560px">
          ...
          <p>Hey ${name},</p>
          <p>Thanks for reaching out about a commission! I've received your request for a <strong style="color:#00aadd">${tier}</strong> build.</p>
          ...
          <br/>
          <p style="color:#00aadd">— BehemothCipher</p>
    ...
    await transporter.sendMail({
      ...
      html: `
        <div style="font-family:'Poppins',sans-serif;padding:24px">
